...
.method crypto_sign(Lorg/bouncycastle/pqc/crypto/sphincs/HashFunctions;[B[B)[B
    ...
    invoke-interface {v4, v11, v6, v12}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    array-length v6, v10

    invoke-interface {v4, v10, v2, v6}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    invoke-interface {v4, v15, v2}, Lorg/bouncycastle/crypto/Digest;->doFinal([BI)I
