...
.method public verifyRawSignature(Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;[BLorg/bouncycastle/crypto/params/AsymmetricKeyParameter;[B)Z
    ...
    invoke-virtual {p0, p1, v0, v1, p3}, Lorg/bouncycastle/crypto/tls/TlsRSASigner;->makeSigner(Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;ZZLorg/bouncycastle/crypto/CipherParameters;)Lorg/bouncycastle/crypto/Signer;

    move-result-object p1

    array-length p3, p4

    invoke-interface {p1, p4, v1, p3}, Lorg/bouncycastle/crypto/Signer;->update([BII)V
