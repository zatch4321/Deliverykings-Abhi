...
.method public decodeCiphertext(JS[BII)[B
    ...
    iget v8, v1, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->nonceMode:I
    ...
    invoke-static {v2, v3, v7, v6}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeUint64(J[BI)V

    const/4 v5, 0x0

    :goto_0
    iget-object v6, v1, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->decryptImplicitNonce:[B
    ...
    invoke-interface {v0, v15}, Lorg/bouncycastle/crypto/modes/AEADBlockCipher;->getOutputSize(I)I
    ...
    invoke-direct {v3, v5, v6, v7, v2}, Lorg/bouncycastle/crypto/params/AEADParameters;-><init>(Lorg/bouncycastle/crypto/params/KeyParameter;I[B[B)V
    ...
    invoke-interface {v2, v11, v3}, Lorg/bouncycastle/crypto/modes/AEADBlockCipher;->init(ZLorg/bouncycastle/crypto/CipherParameters;)V

    iget-object v12, v1, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->decryptCipher:Lorg/bouncycastle/crypto/modes/AEADBlockCipher;
    ...
    invoke-interface/range {v12 .. v17}, Lorg/bouncycastle/crypto/modes/AEADBlockCipher;->processBytes([BII[BI)I
    ...
    invoke-interface {v3, v4, v2}, Lorg/bouncycastle/crypto/modes/AEADBlockCipher;->doFinal([BI)I
...
.method public encodePlaintext(JS[BII)[B
    ...
    invoke-static {p1, p2, v6, v4}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeUint64(J[BI)V

    const/4 v4, 0x0

    :goto_0
    iget-object v7, v1, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->encryptImplicitNonce:[B
    ...
    :cond_3
    iget v10, v1, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->record_iv_length:I

    move/from16 v4, p3

    invoke-virtual {p0, p1, p2, v4, v0}, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->getAdditionalData(JSI)[B
    ...
    invoke-direct {v3, v4, v5, v6, v2}, Lorg/bouncycastle/crypto/params/AEADParameters;-><init>(Lorg/bouncycastle/crypto/params/KeyParameter;I[B[B)V
    ...
    invoke-interface {v0, v12, v10}, Lorg/bouncycastle/crypto/modes/AEADBlockCipher;->doFinal([BI)I
