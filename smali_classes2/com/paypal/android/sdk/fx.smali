.class public final Lcom/paypal/android/sdk/fx;
...
.field public f:Lcom/paypal/android/sdk/fy;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/paypal/android/sdk/fx;->c:[Landroid/widget/TextView;

    invoke-static {p1}, Lcom/paypal/android/sdk/cz;->a(Landroid/content/Context;)Landroid/view/ViewGroup;

    move-result-object v1

    iput-object v1, p0, Lcom/paypal/android/sdk/fx;->j:Landroid/view/ViewGroup;

    invoke-static {v1}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/ViewGroup;)Landroid/widget/LinearLayout;

    move-result-object v1

    iput-object v1, p0, Lcom/paypal/android/sdk/fx;->k:Landroid/widget/LinearLayout;

    invoke-static {v1}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/ViewGroup;)Landroid/widget/LinearLayout;
    ...
    iput-object v2, p0, Lcom/paypal/android/sdk/fx;->b:Landroid/widget/TextView;

    const-string v3, "0dip"

    const-string v4, "14dip"

    invoke-static {v2, v3, v3, v3, v4}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, p0, Lcom/paypal/android/sdk/fx;->b:Landroid/widget/TextView;
    ...
    invoke-static {v2, v3, v3}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;II)V

    new-instance v2, Landroid/widget/ImageView;

    invoke-direct {v2, p1}, Landroid/widget/ImageView;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, Lcom/paypal/android/sdk/fx;->l:Landroid/widget/ImageView;
    ...
    invoke-static {v4, p1}, Lcom/paypal/android/sdk/cz;->c(Ljava/lang/String;Landroid/content/Context;)Landroid/graphics/Bitmap;

    move-result-object v4

    invoke-virtual {v2, v4}, Landroid/widget/ImageView;->setImageBitmap(Landroid/graphics/Bitmap;)V

    iget-object v2, p0, Lcom/paypal/android/sdk/fx;->l:Landroid/widget/ImageView;
    ...
    invoke-static {v2, v4, v5}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;ILjava/lang/String;)V
    ...
    invoke-static {v2, v5, v5, v5, v6}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v9, p0, Lcom/paypal/android/sdk/fx;->c:[Landroid/widget/TextView;

    new-instance v10, Landroid/widget/TextView;

    invoke-direct {v10, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    sget v11, Lcom/paypal/android/sdk/cy;->k:I

    invoke-virtual {v10, v11}, Landroid/widget/TextView;->setTextColor(I)V

    sget-object v11, Lcom/paypal/android/sdk/cy;->t:Landroid/content/res/ColorStateList;

    invoke-virtual {v10, v11}, Landroid/widget/TextView;->setLinkTextColor(Landroid/content/res/ColorStateList;)V

    sget-object v11, Lcom/paypal/android/sdk/cy;->s:Landroid/graphics/Typeface;
    ...
    invoke-static {v10, v4, v3}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;II)V

    invoke-static {v10, v5, v6}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v9, v2}, Landroid/widget/TextView;->setFocusable(Z)V
    ...
    iget-object v8, p0, Lcom/paypal/android/sdk/fx;->c:[Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/fx;->d:Landroid/widget/TextView;

    const/4 v2, 0x2

    invoke-virtual {v0, v2}, Landroid/widget/TextView;->setId(I)V

    iget-object v0, p0, Lcom/paypal/android/sdk/fx;->d:Landroid/widget/TextView;

    invoke-static {v0}, Lcom/paypal/android/sdk/cz;->b(Landroid/widget/TextView;)V
    ...
    invoke-static {v0, v4, v3}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;II)V

    iget-object v0, p0, Lcom/paypal/android/sdk/fx;->d:Landroid/widget/TextView;

    const-string v7, "20dip"

    invoke-static {v0, v7, v6}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lcom/paypal/android/sdk/fx;->d:Landroid/widget/TextView;

    const/4 v9, 0x1

    invoke-virtual {v0, v9}, Landroid/widget/TextView;->setNextFocusRightId(I)V

    new-instance v0, Landroid/widget/TextView;

    invoke-direct {v0, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/paypal/android/sdk/fx;->e:Landroid/widget/TextView;

    const/4 v10, 0x4

    invoke-virtual {v0, v10}, Landroid/widget/TextView;->setId(I)V

    iget-object v0, p0, Lcom/paypal/android/sdk/fx;->e:Landroid/widget/TextView;
    ...
    invoke-static {v0, v5, v7, v5, v6}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lcom/paypal/android/sdk/fx;->e:Landroid/widget/TextView;

    invoke-virtual {v0, v8}, Landroid/widget/TextView;->setVisibility(I)V

    invoke-static {p1, v9, v9, v1}, Lcom/paypal/android/sdk/cz;->a(Landroid/content/Context;ZILandroid/widget/LinearLayout;)Landroid/widget/LinearLayout;

    move-result-object v0

    iput-object v0, p0, Lcom/paypal/android/sdk/fx;->h:Landroid/widget/LinearLayout;

    invoke-virtual {v0, v2}, Landroid/widget/LinearLayout;->setNextFocusLeftId(I)V

    iget-object v0, p0, Lcom/paypal/android/sdk/fx;->h:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/fx;->i:Landroid/widget/TextView;

    invoke-static {v0}, Lcom/paypal/android/sdk/cz;->a(Landroid/widget/TextView;)V

    iget-object v0, p0, Lcom/paypal/android/sdk/fx;->i:Landroid/widget/TextView;
    ...
    iget-object v4, p0, Lcom/paypal/android/sdk/fx;->i:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/fx;->g:Landroid/widget/Button;

    invoke-virtual {v0, v2}, Landroid/widget/Button;->setId(I)V

    iget-object v0, p0, Lcom/paypal/android/sdk/fx;->g:Landroid/widget/Button;

    invoke-static {v0}, Lcom/paypal/android/sdk/cz;->a(Landroid/widget/Button;)V
    ...
    invoke-static {v0, v5, v5, v5, v1}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lcom/paypal/android/sdk/fx;->g:Landroid/widget/Button;

    invoke-static {v0, v3, v3}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;II)V
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/fx;->f:Lcom/paypal/android/sdk/fy;

    iget-object p1, p0, Lcom/paypal/android/sdk/fx;->k:Landroid/widget/LinearLayout;

    iget-object v0, v0, Lcom/paypal/android/sdk/fy;->a:Landroid/widget/LinearLayout;

    invoke-virtual {p1, v0}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    iget-object p1, p0, Lcom/paypal/android/sdk/fx;->f:Lcom/paypal/android/sdk/fy;
    ...
    invoke-static {p1, v1, v2}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;IF)V

    iget-object p1, p0, Lcom/paypal/android/sdk/fx;->j:Landroid/view/ViewGroup;

    iput-object p1, p0, Lcom/paypal/android/sdk/fx;->a:Landroid/view/ViewGroup;
