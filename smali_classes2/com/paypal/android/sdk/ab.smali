...
.method public constructor <init>()V
    ...
    const-string v3, "Telefone"

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->S:Lcom/paypal/android/sdk/fw;

    const-string v4, "Fuso hor\u00e1rio"

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->T:Lcom/paypal/android/sdk/fw;

    const-string v4, "Compartilhar: %s."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->U:Lcom/paypal/android/sdk/fw;

    const-string v4, "Usar Checkout cont\u00ednuo."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->V:Lcom/paypal/android/sdk/fw;

    const-string v4, "%s pede que voc\u00ea:"

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->W:Lcom/paypal/android/sdk/fw;

    const-string v4, "Compartilhar os <a href=\'%1$s\'>meios de pagamento</a> adicionados \u00e0 sua conta do PayPal."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->X:Lcom/paypal/android/sdk/fw;

    const-string v5, "Ativar a exibi\u00e7\u00e3o de seus meios de pagamento para escolher com qual pagar."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->Y:Lcom/paypal/android/sdk/fw;

    const-string v5, "<a href=\'%1$s\'>Autorizar cobran\u00e7as</a> para compras futuras com PayPal no parceiro %2$s. Voc\u00ea autoriza o PayPal a pagar todos os valores solicitados por %3$s."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->Z:Lcom/paypal/android/sdk/fw;

    const-string v5, "Permite adicionar e gerenciar os cart\u00f5es fidelidade \u00e0 sua carteira do PayPal."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aa:Lcom/paypal/android/sdk/fw;

    const-string v5, "Concorde com a <a href=\'%2$s\'>Pol\u00edtica de Privacidade</a> e o <a href=\'%3$s\'>Contrato do Usu\u00e1rio</a> do parceiro %1$s."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->ab:Lcom/paypal/android/sdk/fw;

    const-string v5, "Autorize a <a href=\'%1$s\'>solicita\u00e7\u00e3o de pagamentos</a> em seu nome at\u00e9 voc\u00ea cancelar o consentimento."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->ac:Lcom/paypal/android/sdk/fw;

    const-string v5, "Autorize o <a href=\'%1$s\'>envio de pagamentos</a> em seu nome at\u00e9 voc\u00ea cancelar o consentimento."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->ad:Lcom/paypal/android/sdk/fw;

    const-string v5, "Permiss\u00e3o"
    ...
    const-string v3, "Compartilhar informa\u00e7\u00f5es sobre os <a href=\'%1$s\'>meios de pagamento</a> adicionados \u00e0 sua conta do PayPal."
    ...
    const-string v5, "Compartilhar <a href=\'%1$s\'>meios de pagamento</a> em seu nome at\u00e9 voc\u00ea cancelar o consentimento."
    ...
    const-string v6, "Compartilhar informa\u00e7\u00f5es com eles sobre os <a href=\'%1$s\'>meios de pagamento</a> adicionados \u00e0 sua conta do PayPal."
    ...
    const-string v3, "<a href=\'%1$s\'>Autorize cobran\u00e7as</a> para compras futuras com o PayPal. Voc\u00ea autoriza e define o PayPal para pagar todos os valores."
    ...
    const-string v3, "Pr\u00e9-aprove pagamentos futuros feitos com sua conta do PayPal sem ter que acessar o PayPal toda vez. <a href=\'%1$s\'>Consulte os Termos Adicionais</a>, incluindo meios de pagamento e como cancelar pagamentos futuros."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CONSENT_AGREEMENT_REQUEST_MONEY|AT"

    const-string v3, "Autorizar %2$s a <a href=\'%1$s\'>solicitar pagamento</a> em seu nome at\u00e9 voc\u00ea cancelar o consentimento."
    ...
    const-string v3, "Autorizar %2$s a <a href=\'%1$s\'>enviar pagamento</a> em seu nome at\u00e9 voc\u00ea cancelar o consentimento."
    ...
    const-string v3, "<h1><strong>Meios de pagamento</strong></h1><p>O PayPal compartilha apenas quais dos seus meios de pagamento est\u00e3o dispon\u00edveis para uso.</p>"

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "FINANCIAL_INSTRUMENTS_LEGAL_DETAILS|BE"

    const-string v4, "<h1><strong>Meios de pagamento</strong></h1><p>O PayPal compartilha apenas informa\u00e7\u00f5es sobre quais dos seus meios de pagamento est\u00e3o dispon\u00edveis para uso.</p>"
    ...
    const-string v3, "Log in com PayPal"
    ...
    const-string v4, "<h1><strong>%s</strong></h1><p>Qualquer detalhe relevante da transa\u00e7\u00e3o ser\u00e1 compartilhado com o vendedor.</p><p>Para cancelar o consentimento, acesse o site paypal.com e v\u00e1 para a op\u00e7\u00e3o <strong>Log in com PayPal</strong> nas configura\u00e7\u00f5es do <strong>Perfil</strong> e remova esse vendedor.</p>"
    ...
    const-string v3, "O valor total dos produtos no carrinho n\u00e3o coincide com o valor da venda."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "AUTHORIZATION_ALREADY_COMPLETED"

    const-string v3, "Esta autoriza\u00e7\u00e3o j\u00e1 foi conclu\u00edda."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "AUTHORIZATION_CANNOT_BE_VOIDED"

    const-string v3, "O estado da autoriza\u00e7\u00e3o n\u00e3o permite a anula\u00e7\u00e3o."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "AUTHORIZATION_EXPIRED"

    const-string v3, "A autoriza\u00e7\u00e3o expirou."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "AUTHORIZATION_ID_DOES_NOT_EXIST"

    const-string v3, "O ID de autoriza\u00e7\u00e3o solicitado n\u00e3o existe."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "AUTHORIZATION_VOIDED"

    const-string v3, "A autoriza\u00e7\u00e3o foi anulada."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CANNOT_REAUTH_CHILD_AUTHORIZATION"

    const-string v3, "S\u00f3 \u00e9 poss\u00edvel reautorizar a autoriza\u00e7\u00e3o original, n\u00e3o uma nova autoriza\u00e7\u00e3o."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CANNOT_REAUTH_INSIDE_HONOR_PERIOD"

    const-string v3, "Nova autoriza\u00e7\u00e3o n\u00e3o permitida no per\u00edodo de cumprimento."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CAPTURE_AMOUNT_LIMIT_EXCEEDED"

    const-string v3, "O valor excede o limite permitido."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CARD_TOKEN_PAYER_MISMATCH"

    const-string v4, "N\u00e3o \u00e9 poss\u00edvel acessar as informa\u00e7\u00f5es salvas do cart\u00e3o."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CREDIT_CARD_CVV_CHECK_FAILED"

    const-string v5, "Informa\u00e7\u00f5es do cart\u00e3o inv\u00e1lidas. Corrija e envie novamente."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CREDIT_CARD_REFUSED"

    const-string v5, "Cart\u00e3o recusado."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CURRENCY_MISMATCH"

    const-string v5, "A moeda de captura deve ser a mesma que a moeda da autoriza\u00e7\u00e3o."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CURRENCY_NOT_ALLOWED"

    const-string v5, "O PayPal n\u00e3o aceita esta moeda no momento."
    ...
    const-string v5, "Cart\u00e3o vencido"

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "EXPIRED_CREDIT_CARD_TOKEN"

    const-string v5, "As informa\u00e7\u00f5es desse cart\u00e3o foram apagadas.\nCadastre-o novamente."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "FEATURE_UNSUPPORTED_FOR_PAYEE"

    const-string v5, "N\u00e3o h\u00e1 suporte desse recurso para esse fornecedor."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "FULL_REFUND_NOT_ALLOWED_AFTER_PARTIAL_REFUND"

    const-string v5, "Esta transa\u00e7\u00e3o j\u00e1 foi parcialmente reembolsada."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "IMMEDIATE_PAY_NOT_SUPPORTED"

    const-string v5, "N\u00e3o h\u00e1 suporte do Pagamento imediato para a finalidade transmitida."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "INSTRUMENT_DECLINED"

    const-string v5, "O meio de pagamento selecionado n\u00e3o foi aceito. Escolha outro meio de pagamento."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "INSUFFICIENT_FUNDS"

    const-string v5, "Comprador n\u00e3o pode pagar - fundos insuficientes."
    ...
    const-string v5, "Esse n\u00famero de conta n\u00e3o existe."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "INVALID_ARGUMENT"

    const-string v5, "Transa\u00e7\u00e3o recusada: argumento inv\u00e1lido"

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "INVALID_CITY_STATE_ZIP"

    const-string v5, "Combina\u00e7\u00e3o de cidade/estado/cep inv\u00e1lida."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "INVALID_FACILITATOR_CONFIGURATION"

    const-string v5, "A transa\u00e7\u00e3o n\u00e3o pode ser processada porque a configura\u00e7\u00e3o de facilitador \u00e9 inv\u00e1lida."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "INVALID_PAYER_ID"

    const-string v5, "Erro do sistema (ID de pagador inv\u00e1lido). Tente novamente mais tarde."
    ...
    const-string v5, "A conta do fornecedor n\u00e3o possui um e-mail confirmado."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYEE_ACCOUNT_LOCKED_OR_CLOSED"

    const-string v5, "O fornecedor n\u00e3o pode receber pagamentos agora."
    ...
    const-string v5, "Sua conta foi bloqueada ou fechada."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYER_ACCOUNT_RESTRICTED"

    const-string v5, "Sua conta est\u00e1 restrita."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYER_CANNOT_PAY"

    const-string v5, "Voc\u00ea n\u00e3o pode pagar esta transa\u00e7\u00e3o com PayPal."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYER_EMPTY_BILLING_ADDRESS"

    const-string v5, "Endere\u00e7o de cobran\u00e7a obrigat\u00f3rio para transa\u00e7\u00f5es com cart\u00e3o sem PayPal."
    ...
    const-string v4, "A aprova\u00e7\u00e3o do pagamento venceu."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYMENT_EXPIRED"

    const-string v4, "O pagamento venceu."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYMENT_NOT_APPROVED_FOR_EXECUTION"

    const-string v4, "O pagador n\u00e3o aprovou o pagamento."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYMENT_REQUEST_ID_INVALID"

    const-string v4, "A solicita\u00e7\u00e3o do PayPal \u00e9 inv\u00e1lida. Tente novamente mais tarde."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYMENT_STATE_INVALID"

    const-string v4, "Solicita\u00e7\u00e3o inv\u00e1lida devido ao status atual do pagamento."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PERMISSION_DENIED"

    const-string v4, "Sem permiss\u00e3o para a opera\u00e7\u00e3o solicitada."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "REFUND_EXCEEDED_TRANSACTION_AMOUNT"

    const-string v4, "O reembolso solicitado excede o valor da transa\u00e7\u00e3o original."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "REFUND_TIME_LIMIT_EXCEEDED"

    const-string v4, "Transa\u00e7\u00e3o muito antiga para reembolso."
    ...
    const-string v4, "Nenhuma reautoriza\u00e7\u00e3o permitida para esta autoriza\u00e7\u00e3o."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "TRANSACTION_ALREADY_REFUNDED"

    const-string v4, "Esta transa\u00e7\u00e3o j\u00e1 foi reembolsada."
    ...
    const-string v3, "A transa\u00e7\u00e3o foi recusada."
    ...
    const-string v3, "As prefer\u00eancias de perfil do vendedor s\u00e3o configuradas para negar automaticamente determinadas transa\u00e7\u00f5es."
    ...
    const-string v3, "N\u00e3o h\u00e1 suporte para o seu pa\u00eds."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "VALIDATION_ERROR"

    const-string v3, "As informa\u00e7\u00f5es de pagamento s\u00e3o inv\u00e1lidas. Corrija e envie novamente."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "ORDER_ALREADY_COMPLETED"

    const-string v3, "O pedido j\u00e1 foi anulado, venceu ou foi conclu\u00eddo."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "MAXIMUM_ALLOWED_AUTHORIZATION_REACHED_FOR_ORDER"

    const-string v3, "Voc\u00ea atingiu o n\u00famero m\u00e1ximo de autoriza\u00e7\u00f5es para o pedido."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "ORDER_VOIDED"

    const-string v3, "O pedido foi anulado."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "ORDER_CANNOT_BE_VOIDED"

    const-string v3, "O status do pedido n\u00e3o permite anula\u00e7\u00e3o."
    ...
    const-string v3, "O vendedor n\u00e3o aceita pagamentos deste tipo."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "DCC_UNSUPPORTED_CURRENCY_CC_TYPE"

    const-string v3, "Moeda sem suporte para o tipo de cart\u00e3o."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "DCC_CC_TYPE_NOT_SUPPORTED"

    const-string v3, "Tipo de cart\u00e3o n\u00e3o suportado."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "ADDRESS_ADDITION_ERROR"

    const-string v3, "Ocorreu um erro ao adicionar o endere\u00e7o de entrega na conta do PayPal."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "DUPLICATE_TRANSACTION"

    const-string v3, "Transa\u00e7\u00e3o duplicada."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "INVALID_SHIPPING_ADDRESS"

    const-string v3, "O endere\u00e7o de entrega informado n\u00e3o \u00e9 v\u00e1lido."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYMENT_CREATION_ERROR"

    const-string v3, "Erro ao fazer este pagamento. Visite o site do PayPal para consultar sua conta."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYMENT_CREATION_ERROR_EXPIRED_PAYMENT_CARD"

    const-string v3, "Erro ao fazer este pagamento - seu cart\u00e3o venceu. Visite o site do PayPal para consultar sua conta."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYMENT_CREATION_ERROR_INSTANT_PAYMENT_REQUIRED"

    const-string v3, "Erro ao fazer este pagamento - obrigat\u00f3rio confirma\u00e7\u00e3o instant\u00e2nea, como com cart\u00e3o de cr\u00e9dito. Visite o site do PayPal para consultar sua conta."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYMENT_CREATION_ERROR_NEED_CONFIRMED_CARD"

    const-string v3, "Erro ao fazer este pagamento - cart\u00e3o precisa ser confirmado. Visite o site do PayPal para consultar sua conta."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYMENT_CREATION_ERROR_NEED_PHONE_NUMBER"

    const-string v3, "Erro ao fazer este pagamento - este aplicativo exige que a conta inclua um n\u00famero de telefone. Visite o site do PayPal para consultar sua conta."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYMENT_CREATION_ERROR_NEED_VALID_FUNDING_INSTRUMENT"

    const-string v3, "Erro ao fazer este pagamento - meio de pagamento v\u00e1lido obrigat\u00f3rio, como bando ou cart\u00e3o. Visite o site do PayPal para consultar sua conta."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYMENT_CREATION_ERROR_NEGATIVE_BALANCE"

    const-string v3, "Erro ao fazer este pagamento - seu saldo est\u00e1 negativo. Visite o site do PayPal para consultar sua conta."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYMENT_CREATION_ERROR_SENDING_LIMIT_REACHED"

    const-string v3, "Erro ao fazer este pagamento - voc\u00ea atingiu seu limite de envio. Visite o site do PayPal para consultar sua conta."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "AUTH_RC_RISK_FAILURE"

    const-string v3, "Recusado por regra de risco."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "AUTH_RC_OFAC_BLOCKED_IP"

    const-string v3, "Cliente n\u00e3o autorizado."
    ...
    const-string v3, "Nome de usu\u00e1rio/senha incorreto. Tente novamente."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "locked_user"

    const-string v3, "Sua conta do PayPal foi temporariamente bloqueada. Tente novamente mais tarde ou acesse www.paypal.com para desbloquear sua conta do PayPal na hora."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "max_attempts_exceeded"

    const-string v3, "M\u00e1ximo de tentativas de acesso excedido. Tente novamente mais tarde."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "invalid_request"

    const-string v3, "Ocorreu um erro."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "unauthorized_client"

    const-string v3, "Solicita\u00e7\u00e3o n\u00e3o autorizada."
    ...
    const-string v4, "Ocorreu um erro."
...
.method public final synthetic a(Ljava/lang/Enum;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    sget-object p2, Lcom/paypal/android/sdk/ab;->a:Ljava/util/Map;
