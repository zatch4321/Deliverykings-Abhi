.class public final Lcom/paypal/android/sdk/gf;
...
.field public c:Lcom/paypal/android/sdk/gk;
...
.field public i:Lcom/paypal/android/sdk/fy;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/gf;->a:Landroid/view/ViewGroup;

    invoke-static {v0}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/ViewGroup;)Landroid/widget/LinearLayout;

    move-result-object v0

    iput-object v0, p0, Lcom/paypal/android/sdk/gf;->n:Landroid/widget/LinearLayout;
    ...
    iput-object v1, p0, Lcom/paypal/android/sdk/gf;->l:Landroid/widget/TextView;

    const-string v2, "Your Order"

    invoke-virtual {v1, v2}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v1, p0, Lcom/paypal/android/sdk/gf;->l:Landroid/widget/TextView;
    ...
    iput-object v1, p0, Lcom/paypal/android/sdk/gf;->c:Lcom/paypal/android/sdk/gk;

    iget-object v1, v1, Lcom/paypal/android/sdk/gk;->b:Landroid/widget/TableLayout;

    invoke-virtual {v0, v1}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    iget-object v1, p0, Lcom/paypal/android/sdk/gf;->c:Lcom/paypal/android/sdk/gk;
    ...
    sget-boolean v7, Lcom/paypal/android/sdk/fu;->a:Z

    const-string v8, "28dip"

    const-string v9, "2.5dip"

    const-string v10, "4dip"

    if-eqz v7, :cond_0

    iget-object v7, p0, Lcom/paypal/android/sdk/gf;->j:Landroid/widget/LinearLayout;

    invoke-virtual {v7, v5}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    invoke-static {v5, v10, v9, v2, v2}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {v5, v3, v8}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;ILjava/lang/String;)V
    ...
    iput-object v7, p0, Lcom/paypal/android/sdk/gf;->f:Landroid/widget/TextView;

    invoke-static {v7}, Lcom/paypal/android/sdk/cz;->a(Landroid/widget/TextView;)V

    iget-object v7, p0, Lcom/paypal/android/sdk/gf;->f:Landroid/widget/TextView;

    const-string v11, "Pay with"

    invoke-virtual {v7, v11}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v7, p0, Lcom/paypal/android/sdk/gf;->j:Landroid/widget/LinearLayout;

    iget-object v11, p0, Lcom/paypal/android/sdk/gf;->f:Landroid/widget/TextView;
    ...
    invoke-static {v5, v2, v2, v2, v4}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v7, Landroid/widget/TextView;

    invoke-direct {v7, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object v7, p0, Lcom/paypal/android/sdk/gf;->d:Landroid/widget/TextView;

    const/high16 v9, 0x41600000    # 14.0f

    invoke-virtual {v7, v9}, Landroid/widget/TextView;->setTextSize(F)V

    iget-object v7, p0, Lcom/paypal/android/sdk/gf;->d:Landroid/widget/TextView;

    sget v9, Lcom/paypal/android/sdk/cy;->l:I
    ...
    invoke-direct {v11, v8, v3}, Landroid/widget/LinearLayout$LayoutParams;-><init>(II)V
    ...
    invoke-static {v7, v2, v8, v2, v10}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v7, Landroid/widget/Button;

    invoke-direct {v7, p1}, Landroid/widget/Button;-><init>(Landroid/content/Context;)V

    iput-object v7, p0, Lcom/paypal/android/sdk/gf;->b:Landroid/widget/Button;

    invoke-virtual {v5, v7}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    iget-object v5, p0, Lcom/paypal/android/sdk/gf;->b:Landroid/widget/Button;

    invoke-static {v5}, Lcom/paypal/android/sdk/cz;->a(Landroid/widget/Button;)V

    iget-object v5, p0, Lcom/paypal/android/sdk/gf;->b:Landroid/widget/Button;

    const-string v7, "24dip"

    invoke-static {v5, v3, v7}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;ILjava/lang/String;)V

    iget-object v5, p0, Lcom/paypal/android/sdk/gf;->b:Landroid/widget/Button;

    const/high16 v7, 0x3f800000    # 1.0f

    invoke-static {v5, v9, v7}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;IF)V

    const/4 v5, 0x0

    const v8, 0xa43b

    invoke-static {p1, v5, v8, v0}, Lcom/paypal/android/sdk/cz;->a(Landroid/content/Context;ZILandroid/widget/LinearLayout;)Landroid/widget/LinearLayout;

    move-result-object v5

    iput-object v5, p0, Lcom/paypal/android/sdk/gf;->h:Landroid/widget/LinearLayout;

    new-instance v5, Landroid/widget/ImageView;

    invoke-direct {v5, p1}, Landroid/widget/ImageView;-><init>(Landroid/content/Context;)V

    iput-object v5, p0, Lcom/paypal/android/sdk/gf;->m:Landroid/widget/ImageView;

    invoke-virtual {v5, v1}, Landroid/widget/ImageView;->setAdjustViewBounds(Z)V

    iget-object v5, p0, Lcom/paypal/android/sdk/gf;->m:Landroid/widget/ImageView;
    ...
    invoke-static {v1, v13, v12}, Landroid/util/TypedValue;->applyDimension(IFLandroid/util/DisplayMetrics;)F
    ...
    const-string v11, "1dip"

    invoke-static {v5, v2, v2, v8, v11}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v5, p0, Lcom/paypal/android/sdk/gf;->m:Landroid/widget/ImageView;

    const-string v8, "22dip"
    ...
    iput-object v5, p0, Lcom/paypal/android/sdk/gf;->g:Landroid/widget/ImageView;

    invoke-virtual {v5, v1}, Landroid/widget/ImageView;->setAdjustViewBounds(Z)V

    iget-object v5, p0, Lcom/paypal/android/sdk/gf;->g:Landroid/widget/ImageView;
    ...
    iget-object v6, p0, Lcom/paypal/android/sdk/gf;->g:Landroid/widget/ImageView;
    ...
    invoke-static {v1, v13, v11}, Landroid/util/TypedValue;->applyDimension(IFLandroid/util/DisplayMetrics;)F

    move-result v1

    float-to-int v1, v1

    invoke-direct {v8, v3, v1}, Landroid/view/ViewGroup$LayoutParams;-><init>(II)V

    invoke-virtual {v5, v6, v8}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v1, p0, Lcom/paypal/android/sdk/gf;->g:Landroid/widget/ImageView;

    invoke-static {v1, v2, v2, v10, v2}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Lcom/paypal/android/sdk/gf;->g:Landroid/widget/ImageView;

    const-string v5, "36dip"

    const-string v6, "25dip"

    invoke-static {v1, v5, v6}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v1, Landroid/widget/TextView;

    invoke-direct {v1, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lcom/paypal/android/sdk/gf;->e:Landroid/widget/TextView;

    invoke-static {v1}, Lcom/paypal/android/sdk/cz;->a(Landroid/widget/TextView;)V

    iget-object v1, p0, Lcom/paypal/android/sdk/gf;->e:Landroid/widget/TextView;

    const-string v5, "Pay with Card"

    invoke-virtual {v1, v5}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v1, p0, Lcom/paypal/android/sdk/gf;->h:Landroid/widget/LinearLayout;

    iget-object v5, p0, Lcom/paypal/android/sdk/gf;->e:Landroid/widget/TextView;
    ...
    iput-object v1, p0, Lcom/paypal/android/sdk/gf;->k:Landroid/widget/Button;

    const v5, 0xa43a

    invoke-virtual {v1, v5}, Landroid/widget/Button;->setId(I)V

    iget-object v1, p0, Lcom/paypal/android/sdk/gf;->k:Landroid/widget/Button;

    invoke-static {v1}, Lcom/paypal/android/sdk/cz;->a(Landroid/widget/Button;)V
    ...
    invoke-static {v1, v2, v2, v2, v4}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Lcom/paypal/android/sdk/gf;->k:Landroid/widget/Button;

    invoke-static {v1, v3, v3}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;II)V

    iget-object v1, p0, Lcom/paypal/android/sdk/gf;->k:Landroid/widget/Button;

    invoke-static {v1, v9, v7}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;IF)V

    new-instance v1, Lcom/paypal/android/sdk/fy;

    invoke-direct {v1, p1}, Lcom/paypal/android/sdk/fy;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lcom/paypal/android/sdk/gf;->i:Lcom/paypal/android/sdk/fy;

    iget-object p1, v1, Lcom/paypal/android/sdk/fy;->a:Landroid/widget/LinearLayout;

    invoke-virtual {v0, p1}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    iget-object p1, p0, Lcom/paypal/android/sdk/gf;->i:Lcom/paypal/android/sdk/fy;

    iget-object p1, p1, Lcom/paypal/android/sdk/fy;->a:Landroid/widget/LinearLayout;

    invoke-static {p1, v3, v3}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;II)V

    iget-object p1, p0, Lcom/paypal/android/sdk/gf;->i:Lcom/paypal/android/sdk/fy;

    iget-object p1, p1, Lcom/paypal/android/sdk/fy;->a:Landroid/widget/LinearLayout;

    invoke-static {p1, v9, v7}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;IF)V
