.class public final Lcom/paypal/android/sdk/gn;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/gn;->c:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/gn;->e:Landroid/widget/RelativeLayout;
    ...
    iget-object v0, p0, Lcom/paypal/android/sdk/gn;->c:Landroid/view/ViewGroup;

    iget-object v1, p0, Lcom/paypal/android/sdk/gn;->e:Landroid/widget/RelativeLayout;

    invoke-virtual {v0, v1}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    iget-object v0, p0, Lcom/paypal/android/sdk/gn;->e:Landroid/widget/RelativeLayout;

    const/4 v1, -0x1

    invoke-static {v0, v1, v1}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;II)V

    new-instance v0, Landroid/widget/LinearLayout;

    invoke-direct {v0, p1}, Landroid/widget/LinearLayout;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/paypal/android/sdk/gn;->g:Landroid/widget/LinearLayout;
    ...
    iget-object v1, p0, Lcom/paypal/android/sdk/gn;->g:Landroid/widget/LinearLayout;

    invoke-virtual {v0, v1}, Landroid/widget/RelativeLayout;->addView(Landroid/view/View;)V

    iget-object v0, p0, Lcom/paypal/android/sdk/gn;->g:Landroid/widget/LinearLayout;
    ...
    invoke-static {v0, v2, v2, v3, v2}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lcom/paypal/android/sdk/gn;->f:Landroid/widget/ImageView;

    invoke-virtual {v0, v4}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    iget-object v0, p0, Lcom/paypal/android/sdk/gn;->f:Landroid/widget/ImageView;

    const-string v4, "220dip"

    const-string v5, "160dip"

    invoke-static {v0, v4, v5}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lcom/paypal/android/sdk/gn;->f:Landroid/widget/ImageView;

    const-string v4, "30dip"

    invoke-static {v0, v2, v2, v2, v4}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v0, Landroid/widget/ProgressBar;

    invoke-direct {v0, p1}, Landroid/widget/ProgressBar;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/paypal/android/sdk/gn;->d:Landroid/widget/ProgressBar;

    iget-object v4, p0, Lcom/paypal/android/sdk/gn;->g:Landroid/widget/LinearLayout;

    invoke-virtual {v4, v0}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    iget-object v0, p0, Lcom/paypal/android/sdk/gn;->d:Landroid/widget/ProgressBar;

    invoke-static {v0, v1, v1}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;II)V

    iget-object v0, p0, Lcom/paypal/android/sdk/gn;->d:Landroid/widget/ProgressBar;

    invoke-static {v0, v2, v2, v2, v3}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v2, v3}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;IF)V

    new-instance v0, Landroid/widget/TextView;

    invoke-direct {v0, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/paypal/android/sdk/gn;->b:Landroid/widget/TextView;

    sget-object p1, Lcom/paypal/android/sdk/cy;->t:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, p1}, Landroid/widget/TextView;->setTextColor(Landroid/content/res/ColorStateList;)V

    iget-object p1, p0, Lcom/paypal/android/sdk/gn;->b:Landroid/widget/TextView;

    sget v0, Lcom/paypal/android/sdk/cy;->h:I
    ...
    iget-object p1, p0, Lcom/paypal/android/sdk/gn;->g:Landroid/widget/LinearLayout;

    iget-object v0, p0, Lcom/paypal/android/sdk/gn;->b:Landroid/widget/TextView;

    invoke-virtual {p1, v0}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    iget-object p1, p0, Lcom/paypal/android/sdk/gn;->b:Landroid/widget/TextView;

    invoke-static {p1, v1, v1}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;II)V

    iget-object p1, p0, Lcom/paypal/android/sdk/gn;->b:Landroid/widget/TextView;

    invoke-static {p1, v2, v3}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;IF)V

    iget-object p1, p0, Lcom/paypal/android/sdk/gn;->c:Landroid/view/ViewGroup;

    iput-object p1, p0, Lcom/paypal/android/sdk/gn;->a:Landroid/view/ViewGroup;
