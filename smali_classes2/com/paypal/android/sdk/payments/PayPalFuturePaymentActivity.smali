...
.field private static final a:Ljava/lang/String; = "PayPalFuturePaymentActivity"
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lcom/paypal/android/sdk/payments/bl;-><init>(Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;)V
...
.method static synthetic a(Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;)Lcom/paypal/android/sdk/payments/ce;
    .locals 0

    invoke-direct {p0}, Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;->c()Lcom/paypal/android/sdk/payments/ce;
...
.method static synthetic b(Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;)Lcom/paypal/android/sdk/payments/PayPalService;
    ...
    iget-object p0, p0, Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;->d:Lcom/paypal/android/sdk/payments/PayPalService;
...
.method private b()V
    ...
    invoke-static {p0, v1, v0}, Lcom/paypal/android/sdk/payments/FuturePaymentConsentActivity;->a(Landroid/app/Activity;ILcom/paypal/android/sdk/payments/PayPalConfiguration;)V
...
.method private c()Lcom/paypal/android/sdk/payments/ce;
    ...
    invoke-direct {v0, p0}, Lcom/paypal/android/sdk/payments/bn;-><init>(Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;)V
...
.method static synthetic c(Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;)V
    ...
    invoke-virtual {p0, v1}, Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;->setResult(I)V
    ...
    iget-object v3, p0, Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;->d:Lcom/paypal/android/sdk/payments/PayPalService;
    ...
    invoke-direct {v0, v2, v3, v4}, Lcom/paypal/android/sdk/payments/bx;-><init>(Landroid/content/Intent;Lcom/paypal/android/sdk/payments/PayPalConfiguration;Z)V
    ...
    invoke-virtual {v0, p0, v4}, Lcom/paypal/android/sdk/payments/PayPalService;->a(Lcom/paypal/android/sdk/payments/ce;Z)V
...
.method static synthetic d(Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;)Ljava/util/Date;
    ...
    iget-object p0, p0, Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;->b:Ljava/util/Date;
...
.method static synthetic f(Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;)Ljava/util/Timer;
    ...
    iget-object p0, p0, Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;->c:Ljava/util/Timer;
...
.method protected final onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-virtual {p0, v1, p3}, Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;->setResult(ILandroid/content/Intent;)V

    goto :goto_1

    :cond_1
    const-string p1, "result was OK, have data, but no authorization state in bundle, oops"
...
.method protected final onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1, v0, v2}, Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;->bindService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z

    move-result p1

    iput-boolean p1, p0, Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;->f:Z
    ...
    invoke-virtual {p0, v0}, Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;->setContentView(Landroid/view/View;)V
...
.method protected final onCreateDialog(ILandroid/os/Bundle;)Landroid/app/Dialog;
    ...
    :cond_1
    new-instance p1, Lcom/paypal/android/sdk/payments/bk;

    invoke-direct {p1, p0}, Lcom/paypal/android/sdk/payments/bk;-><init>(Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;)V
