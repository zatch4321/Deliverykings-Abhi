...
.method public constructor <init>()V
    ...
    const-string v3, "Sprog"

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->Q:Lcom/paypal/android/sdk/fw;

    const-string v3, "Landestandard"
    ...
    const-string v4, "Brug nem betaling."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->V:Lcom/paypal/android/sdk/fw;

    const-string v4, "%s beder dig om at:"

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->W:Lcom/paypal/android/sdk/fw;

    const-string v4, "Del de <a href=\'%1$s\'>betalingsmetoder</a>, der er tilknyttet din PayPal-konto."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->X:Lcom/paypal/android/sdk/fw;

    const-string v4, "Aktiver visning af dine betalingsm\u00e5der, s\u00e5 du kan v\u00e6lge."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->Y:Lcom/paypal/android/sdk/fw;

    const-string v4, "<a href=\'%1$s\'>Godkende, at der tr\u00e6kkes penge</a> for fremtidige k\u00f8b hos %2$s, der betales via PayPal. Du beder os om at betale alle de bel\u00f8b, som %3$s anmoder om."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->Z:Lcom/paypal/android/sdk/fw;

    const-string v4, "Give dem tilladelse til at tilf\u00f8je og administrere deres loyalitetskort i din PayPal-pung."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aa:Lcom/paypal/android/sdk/fw;

    const-string v4, "Acceptere <a href=\'%2$s\'>politikken om beskyttelse af personlige oplysninger</a> og <a href=\'%3$s\'>brugeraftalen</a> for %1$s."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->ab:Lcom/paypal/android/sdk/fw;

    const-string v4, "Giv dem tilladelse til at <a href=\'%1$s\'>anmode om penge</a> p\u00e5 dine vegne, indtil du tr\u00e6kker din tilladelse tilbage."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->ac:Lcom/paypal/android/sdk/fw;

    const-string v4, "Giv dem tilladelse til at <a href=\'%1$s\'>overf\u00f8re penge</a> p\u00e5 dine vegne, indtil du tr\u00e6kker din tilladelse tilbage."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->ad:Lcom/paypal/android/sdk/fw;

    const-string v4, "Samtykke"
    ...
    const-string v3, "Pinkode"

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aC:Lcom/paypal/android/sdk/fw;

    const-string v3, "Foretrukken betalingsmetode"

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aD:Lcom/paypal/android/sdk/fw;

    const-string v3, "Vi beskytter dine <a href=\'%s\'>personlige oplysninger</a> og betalingsoplysninger."
    ...
    const-string v3, "Husk kort"

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aG:Lcom/paypal/android/sdk/fw;

    const-string v3, "Anmod om penge"

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aH:Lcom/paypal/android/sdk/fw;

    const-string v3, "<h1><strong>%s</strong></h1><p>Alle relevante oplysninger om betalingen deles med webbutikken.</p><p>Hvis du vil tr\u00e6kke tilladelsen tilbage, skal du logge p\u00e5 paypal.com, g\u00e5 til sektionen <strong>Log p\u00e5 med PayPal</strong> under <strong>Min profil</strong> og fjerne webbutikken.</p><p>Vi er ikke ansvarlig for nogen af partnerens handlinger eller fejl.</p>"

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aI:Lcom/paypal/android/sdk/fw;

    const-string v3, "Opsparingskonto"

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aJ:Lcom/paypal/android/sdk/fw;

    const-string v3, "Overf\u00f8r penge"

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aK:Lcom/paypal/android/sdk/fw;

    const-string v3, "Der kunne ikke oprettes forbindelse til vores servere. Pr\u00f8v igen."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aL:Lcom/paypal/android/sdk/fw;

    const-string v3, "Log p\u00e5 PayPal igen."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aM:Lcom/paypal/android/sdk/fw;

    const-string v3, "Sessionen er udl\u00f8bet"

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aN:Lcom/paypal/android/sdk/fw;

    const-string v3, "Forsendelsesadresse"

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aO:Lcom/paypal/android/sdk/fw;

    const-string v3, "Har du ikke en PayPal-konto? Opret konto"

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aP:Lcom/paypal/android/sdk/fw;

    const-string v3, "Forbliv logget p\u00e5"

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aQ:Lcom/paypal/android/sdk/fw;

    const-string v3, "Systemfejl (%s). Pr\u00f8v igen senere."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aR:Lcom/paypal/android/sdk/fw;

    const-string v3, "Pr\u00f8v igen"

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aS:Lcom/paypal/android/sdk/fw;

    const-string v3, "Der kunne ikke logges p\u00e5, da to-faktor-godkendelse er aktiveret for din konto."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aT:Lcom/paypal/android/sdk/fw;

    const-string v3, "Sikkerhedskode"

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aU:Lcom/paypal/android/sdk/fw;

    const-string v3, "Send en sms til din telefon. Den 6-cifrede kode, som du modtager, er gyldig i 5 minutter."

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aV:Lcom/paypal/android/sdk/fw;

    const-string v3, "Afsende sms"

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aW:Lcom/paypal/android/sdk/fw;

    const-string v3, "Angiv den 6-cifrede sikkerhedskode"

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/paypal/android/sdk/fw;->aX:Lcom/paypal/android/sdk/fw;

    const-string v3, "Dit mobilnummer"
    ...
    const-string v3, "Forkert sikkerhedskode. Pr\u00f8v igen."
    ...
    const-string v3, "Systemfejl. Pr\u00f8v igen senere."
    ...
    const-string v4, "Del oplysninger om de <a href=\'%1$s\'>betalingsm\u00e5der</a>, der er tilknyttet din PayPal-konto."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CONSENT_AGREEMENT_FINANCIAL_INSTRUMENTS|BE"

    const-string v5, "Del oplysningerne om de <a href=\'%1$s\'>betalingsm\u00e5der</a>, der er tilknyttet din PayPal-konto."

    invoke-interface {v0, v1, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CONSENT_AGREEMENT_FINANCIAL_INSTRUMENTS|BG"

    const-string v6, "Del dine <a href=\'%1$s\'>betalingsm\u00e5der</a> med andre, indtil du tr\u00e6kker din tilladelse tilbage."
    ...
    const-string v4, "Del oplysninger om de <a href=\'%1$s\'>betalingsmetoder</a>, der er tilknyttet din PayPal-konto."
    ...
    const-string v7, "Del oplysninger med vedkommende om de <a href=\'%1$s\'>betalingsm\u00e5der</a>, der er tilknyttet din PayPal-konto."
    ...
    const-string v7, "Del de <a href=\'%1$s\'>betalingsm\u00e5der</a>, der er tilknyttet din PayPal-konto."
    ...
    const-string v4, "<a href=\'%1$s\'>Godkend, at der tr\u00e6kkes penge</a> for fremtidige k\u00f8b, der betales via PayPal. Du beder PayPal om at betale alle bel\u00f8b og godkender dette."
    ...
    const-string v4, "Godkend p\u00e5 forh\u00e5nd fremtidige betalinger fra din PayPal-konto uden at logge p\u00e5 PayPal hver gang. <a href=\'%1$s\'>Se flere vilk\u00e5r</a>, blandt andet betalingsmetoder, og hvordan du annullerer fremtidige betalinger."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CONSENT_AGREEMENT_REQUEST_MONEY|AT"

    const-string v4, "Give %2$s tilladelse til at <a href=\'%1$s\'>anmode om penge</a> p\u00e5 dine vegne, indtil du tr\u00e6kker din tilladelse tilbage."
    ...
    const-string v4, "Give %2$s tilladelse til at <a href=\'%1$s\'>overf\u00f8re penge</a> p\u00e5 dine vegne, indtil du tr\u00e6kker din tilladelse tilbage."
    ...
    const-string v4, "<h1><strong>Betalingsmetoder</strong></h1><p>Vi deler kun oplysninger om, hvilke af dine betalingsm\u00e5der, der kan bruges.</p>"
    ...
    const-string v4, "<h1><strong>%s</strong></h1><p>Alle relevante oplysninger om betalingen deles med webbutikken.</p><p>Hvis du vil tr\u00e6kke tilladelsen tilbage, skal du logge p\u00e5 paypal.com, g\u00e5 til sektionen <strong>Log p\u00e5 med PayPal</strong> under <strong>Min profil</strong> og fjerne webbutikken.</p>"
    ...
    const-string v4, "De gemte kortoplysninger kan ikke \u00e5bnes."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CREDIT_CARD_CVV_CHECK_FAILED"

    const-string v4, "Kortoplysningerne er ugyldige. Ret oplysningerne, og send dem igen."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CREDIT_CARD_REFUSED"

    const-string v4, "Kortet blev afvist."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CURRENCY_MISMATCH"

    const-string v4, "Valuta for hentning skal v\u00e6re den samme som valutaen for autorisationen."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CURRENCY_NOT_ALLOWED"

    const-string v4, "Valutaen underst\u00f8ttes ikke af PayPal."
    ...
    const-string v4, "Kortet er udl\u00f8bet"

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "EXPIRED_CREDIT_CARD_TOKEN"

    const-string v4, "Oplysningerne for dette kort er ikke l\u00e6ngere gemt.\nSend igen."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "FEATURE_UNSUPPORTED_FOR_PAYEE"

    const-string v4, "S\u00e6lgeren underst\u00f8tter ikke denne funktion."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "FULL_REFUND_NOT_ALLOWED_AFTER_PARTIAL_REFUND"

    const-string v4, "Denne betaling er allerede blevet delvist tilbagebetalt."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "IMMEDIATE_PAY_NOT_SUPPORTED"

    const-string v4, "Den overf\u00f8rte hensigt underst\u00f8tter ikke \u00f8jeblikkelig betaling."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "INSTRUMENT_DECLINED"

    const-string v4, "Den valgte betalingsmetode blev ikke godkendt. V\u00e6lg en anden betalingsmetode."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "INSUFFICIENT_FUNDS"

    const-string v4, "Kunden kan ikke betale \u2013 der er ikke penge nok."
    ...
    const-string v4, "Kontonummeret findes ikke."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "INVALID_ARGUMENT"

    const-string v4, "Betalingen blev afvist p\u00e5 grund af et ugyldigt argument"

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "INVALID_CITY_STATE_ZIP"

    const-string v4, "Ugyldig kombination af by, omr\u00e5de og/eller postnummer."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "INVALID_FACILITATOR_CONFIGURATION"

    const-string v4, "Denne betaling kan ikke behandles p\u00e5 grund af en ugyldig formidlerkonfiguration."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "INVALID_PAYER_ID"

    const-string v4, "Systemfejl (ugyldigt betaler-id). Pr\u00f8v igen senere."
    ...
    const-string v4, "S\u00e6lgerkontoen har ikke en en bekr\u00e6ftet e-mailadresse."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYEE_ACCOUNT_LOCKED_OR_CLOSED"

    const-string v5, "Denne s\u00e6lger kan ikke tage imod betalinger i \u00f8jeblikket."
    ...
    const-string v4, "Denne s\u00e6lger kan ikke tage imod betalinger i \u00f8jeblikket."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYER_ACCOUNT_LOCKED_OR_CLOSED"

    const-string v4, "Din konto er l\u00e5st eller lukket."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYER_ACCOUNT_RESTRICTED"

    const-string v4, "Din konto er begr\u00e6nset."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYER_CANNOT_PAY"

    const-string v4, "Du kan ikke bruge PayPal til denne betaling."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYER_EMPTY_BILLING_ADDRESS"

    const-string v4, "Der skal angives en faktureringsadresse ved de kortbetalinger, der ikke foretages via PayPal."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYER_ID_MISSING_FOR_CARD_TOKEN"

    const-string v4, "Kan ikke f\u00e5 adgang til gemte kortoplysninger."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYMENT_APPROVAL_EXPIRED"

    const-string v4, "Godkendelsen af betalingen er udl\u00f8bet."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYMENT_EXPIRED"

    const-string v4, "Betalingen er udl\u00f8bet."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYMENT_NOT_APPROVED_FOR_EXECUTION"

    const-string v4, "Betaleren har ikke godkendt betalingen."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYMENT_REQUEST_ID_INVALID"

    const-string v4, "Id\u2019et for PayPal-anmodningen er ugyldigt. Pr\u00f8v igen senere."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PAYMENT_STATE_INVALID"

    const-string v4, "Denne anmodning er ugyldig p\u00e5 grund af den aktuelle tilstand for betaling."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "PERMISSION_DENIED"

    const-string v4, "Du har ikke tilladelse til at udf\u00f8re handlingen."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "REFUND_EXCEEDED_TRANSACTION_AMOUNT"

    const-string v4, "Den anmodede tilbagebetaling overstiger det oprindelige bel\u00f8b."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "REFUND_TIME_LIMIT_EXCEEDED"

    const-string v4, "Du kan ikke l\u00e6ngere f\u00e5 tilbagebetalt denne betaling."
    ...
    const-string v4, "Du m\u00e5 ikke gentage denne autorisation flere gange."

    invoke-interface {v0, v1, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "TRANSACTION_ALREADY_REFUNDED"

    const-string v4, "Betalingen er allerede blevet tilbagebetalt."
    ...
    const-string v4, "Der opstod en fejl."
...
.method public final synthetic a(Ljava/lang/Enum;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    sget-object p2, Lcom/paypal/android/sdk/j;->a:Ljava/util/Map;
