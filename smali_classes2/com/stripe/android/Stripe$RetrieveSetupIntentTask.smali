.class final Lcom/stripe/android/Stripe$RetrieveSetupIntentTask;
...
.method public constructor <init>(Lcom/stripe/android/StripeRepository;Ljava/lang/String;Lcom/stripe/android/ApiRequest$Options;Lkotlinx/coroutines/CoroutineScope;Lcom/stripe/android/ApiResultCallback;)V
    ...
    iput-object p1, p0, Lcom/stripe/android/Stripe$RetrieveSetupIntentTask;->stripeRepository:Lcom/stripe/android/StripeRepository;

    iput-object p2, p0, Lcom/stripe/android/Stripe$RetrieveSetupIntentTask;->clientSecret:Ljava/lang/String;

    iput-object p3, p0, Lcom/stripe/android/Stripe$RetrieveSetupIntentTask;->options:Lcom/stripe/android/ApiRequest$Options;
...
.method public synthetic constructor <init>(Lcom/stripe/android/StripeRepository;Ljava/lang/String;Lcom/stripe/android/ApiRequest$Options;Lkotlinx/coroutines/CoroutineScope;Lcom/stripe/android/ApiResultCallback;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/stripe/android/Stripe$RetrieveSetupIntentTask;-><init>(Lcom/stripe/android/StripeRepository;Ljava/lang/String;Lcom/stripe/android/ApiRequest$Options;Lkotlinx/coroutines/CoroutineScope;Lcom/stripe/android/ApiResultCallback;)V
...
.method public getResult$stripe_release(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/stripe/android/Stripe$RetrieveSetupIntentTask;->stripeRepository:Lcom/stripe/android/StripeRepository;

    iget-object v1, p0, Lcom/stripe/android/Stripe$RetrieveSetupIntentTask;->clientSecret:Ljava/lang/String;

    iget-object v2, p0, Lcom/stripe/android/Stripe$RetrieveSetupIntentTask;->options:Lcom/stripe/android/ApiRequest$Options;
    ...
    invoke-static/range {v0 .. v5}, Lcom/stripe/android/StripeRepository$DefaultImpls;->retrieveSetupIntent$default(Lcom/stripe/android/StripeRepository;Ljava/lang/String;Lcom/stripe/android/ApiRequest$Options;Ljava/util/List;ILjava/lang/Object;)Lcom/stripe/android/model/SetupIntent;
