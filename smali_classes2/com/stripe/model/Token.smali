...
.method public static create(Lcom/stripe/param/TokenCreateParams;)Lcom/stripe/model/Token;
    .locals 1
    ...
    invoke-static {p0, v0}, Lcom/stripe/model/Token;->create(Lcom/stripe/param/TokenCreateParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Token;
...
.method public static create(Lcom/stripe/param/TokenCreateParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Token;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    check-cast p0, Lcom/stripe/model/Token;
...
.method public static retrieve(Ljava/lang/String;)Lcom/stripe/model/Token;
    ...
    invoke-static {p0, v1, v0}, Lcom/stripe/model/Token;->retrieve(Ljava/lang/String;Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Token;
...
.method public static retrieve(Ljava/lang/String;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Token;
    ...
    invoke-static {p0, v0, p1}, Lcom/stripe/model/Token;->retrieve(Ljava/lang/String;Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Token;
...
.method public static retrieve(Ljava/lang/String;Lcom/stripe/param/TokenRetrieveParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Token;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
...
.method public static retrieve(Ljava/lang/String;Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Token;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected canEqual(Ljava/lang/Object;)Z
    ...
    instance-of p1, p1, Lcom/stripe/model/Token;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v1, p1, Lcom/stripe/model/Token;
    ...
    :cond_1
    check-cast p1, Lcom/stripe/model/Token;

    invoke-virtual {p1, p0}, Lcom/stripe/model/Token;->canEqual(Ljava/lang/Object;)Z
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/stripe/model/Token;->getBankAccount()Lcom/stripe/model/BankAccount;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Token;->getBankAccount()Lcom/stripe/model/BankAccount;
    ...
    :cond_4
    invoke-virtual {p0}, Lcom/stripe/model/Token;->getCard()Lcom/stripe/model/Card;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Token;->getCard()Lcom/stripe/model/Card;
    ...
    :cond_6
    invoke-virtual {p0}, Lcom/stripe/model/Token;->getClientIp()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Token;->getClientIp()Ljava/lang/String;
    ...
    :cond_8
    invoke-virtual {p0}, Lcom/stripe/model/Token;->getCreated()Ljava/lang/Long;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Token;->getCreated()Ljava/lang/Long;
    ...
    :cond_a
    invoke-virtual {p0}, Lcom/stripe/model/Token;->getId()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Token;->getId()Ljava/lang/String;
    ...
    :cond_c
    invoke-virtual {p0}, Lcom/stripe/model/Token;->getLivemode()Ljava/lang/Boolean;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Token;->getLivemode()Ljava/lang/Boolean;
    ...
    :cond_e
    invoke-virtual {p0}, Lcom/stripe/model/Token;->getObject()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Token;->getObject()Ljava/lang/String;
    ...
    :cond_10
    invoke-virtual {p0}, Lcom/stripe/model/Token;->getType()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Token;->getType()Ljava/lang/String;
    ...
    :cond_12
    invoke-virtual {p0}, Lcom/stripe/model/Token;->getUsed()Ljava/lang/Boolean;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Token;->getUsed()Ljava/lang/Boolean;
...
.method public getObject()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/stripe/model/Token;->object:Ljava/lang/String;
...
.method public setObject(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/stripe/model/Token;->object:Ljava/lang/String;
