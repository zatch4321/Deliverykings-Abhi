...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/stripe/model/Sku$Inventory;
    }
.end annotation
...
.field inventory:Lcom/stripe/model/Sku$Inventory;
    .annotation runtime Lcom/google/gson/annotations/SerializedName;
        value = "inventory"
    .end annotation
.end field
...
.method public static create(Lcom/stripe/param/SkuCreateParams;)Lcom/stripe/model/Sku;
    .locals 1
    ...
    invoke-static {p0, v0}, Lcom/stripe/model/Sku;->create(Lcom/stripe/param/SkuCreateParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Sku;
...
.method public static create(Lcom/stripe/param/SkuCreateParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Sku;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    check-cast p0, Lcom/stripe/model/Sku;
...
.method public static list(Lcom/stripe/param/SkuListParams;)Lcom/stripe/model/SkuCollection;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    invoke-static {p0, v0}, Lcom/stripe/model/Sku;->list(Lcom/stripe/param/SkuListParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/SkuCollection;
...
.method public static list(Lcom/stripe/param/SkuListParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/SkuCollection;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    check-cast p0, Lcom/stripe/model/SkuCollection;
...
.method public static retrieve(Ljava/lang/String;)Lcom/stripe/model/Sku;
    ...
    invoke-static {p0, v1, v0}, Lcom/stripe/model/Sku;->retrieve(Ljava/lang/String;Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Sku;
...
.method public static retrieve(Ljava/lang/String;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Sku;
    ...
    invoke-static {p0, v0, p1}, Lcom/stripe/model/Sku;->retrieve(Ljava/lang/String;Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Sku;
...
.method public static retrieve(Ljava/lang/String;Lcom/stripe/param/SkuRetrieveParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Sku;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
...
.method public static retrieve(Ljava/lang/String;Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Sku;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected canEqual(Ljava/lang/Object;)Z
    ...
    instance-of p1, p1, Lcom/stripe/model/Sku;

    return p1
.end method

.method public delete()Lcom/stripe/model/Sku;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    invoke-virtual {p0, v1, v0}, Lcom/stripe/model/Sku;->delete(Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Sku;
...
.method public delete(Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Sku;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    invoke-virtual {p0, v0, p1}, Lcom/stripe/model/Sku;->delete(Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Sku;
...
.method public delete(Ljava/util/Map;)Lcom/stripe/model/Sku;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, v0}, Lcom/stripe/model/Sku;->delete(Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Sku;
...
.method public delete(Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Sku;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0}, Lcom/stripe/model/Sku;->getId()Ljava/lang/String;
    ...
    check-cast p1, Lcom/stripe/model/Sku;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v1, p1, Lcom/stripe/model/Sku;
    ...
    invoke-virtual {p1, p0}, Lcom/stripe/model/Sku;->canEqual(Ljava/lang/Object;)Z
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/stripe/model/Sku;->getActive()Ljava/lang/Boolean;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Sku;->getActive()Ljava/lang/Boolean;
    ...
    :cond_4
    invoke-virtual {p0}, Lcom/stripe/model/Sku;->getAttributes()Ljava/util/Map;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Sku;->getAttributes()Ljava/util/Map;
    ...
    :cond_6
    invoke-virtual {p0}, Lcom/stripe/model/Sku;->getCreated()Ljava/lang/Long;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Sku;->getCreated()Ljava/lang/Long;
    ...
    :cond_8
    invoke-virtual {p0}, Lcom/stripe/model/Sku;->getCurrency()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Sku;->getCurrency()Ljava/lang/String;
    ...
    :cond_a
    invoke-virtual {p0}, Lcom/stripe/model/Sku;->getDeleted()Ljava/lang/Boolean;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Sku;->getDeleted()Ljava/lang/Boolean;
    ...
    :cond_e
    invoke-virtual {p0}, Lcom/stripe/model/Sku;->getImage()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Sku;->getImage()Ljava/lang/String;
    ...
    :cond_10
    invoke-virtual {p0}, Lcom/stripe/model/Sku;->getInventory()Lcom/stripe/model/Sku$Inventory;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Sku;->getInventory()Lcom/stripe/model/Sku$Inventory;
    ...
    :cond_12
    invoke-virtual {p0}, Lcom/stripe/model/Sku;->getLivemode()Ljava/lang/Boolean;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Sku;->getLivemode()Ljava/lang/Boolean;
    ...
    :cond_14
    invoke-virtual {p0}, Lcom/stripe/model/Sku;->getMetadata()Ljava/util/Map;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Sku;->getMetadata()Ljava/util/Map;
    ...
    :cond_16
    invoke-virtual {p0}, Lcom/stripe/model/Sku;->getObject()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Sku;->getObject()Ljava/lang/String;
    ...
    :cond_18
    invoke-virtual {p0}, Lcom/stripe/model/Sku;->getPackageDimensions()Lcom/stripe/model/PackageDimensions;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Sku;->getPackageDimensions()Lcom/stripe/model/PackageDimensions;
    ...
    :cond_1a
    invoke-virtual {p0}, Lcom/stripe/model/Sku;->getPrice()Ljava/lang/Long;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Sku;->getPrice()Ljava/lang/Long;
    ...
    :cond_1c
    invoke-virtual {p0}, Lcom/stripe/model/Sku;->getProduct()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Sku;->getProduct()Ljava/lang/String;
    ...
    :cond_1e
    invoke-virtual {p0}, Lcom/stripe/model/Sku;->getUpdated()Ljava/lang/Long;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Sku;->getUpdated()Ljava/lang/Long;
...
.method public getDeleted()Ljava/lang/Boolean;
    ...
    iget-object v0, p0, Lcom/stripe/model/Sku;->deleted:Ljava/lang/Boolean;
...
.method public getInventory()Lcom/stripe/model/Sku$Inventory;
    .locals 1

    iget-object v0, p0, Lcom/stripe/model/Sku;->inventory:Lcom/stripe/model/Sku$Inventory;
...
.method public getObject()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/stripe/model/Sku;->object:Ljava/lang/String;
...
.method public getPrice()Ljava/lang/Long;
    ...
    iget-object v0, p0, Lcom/stripe/model/Sku;->price:Ljava/lang/Long;
...
.method public getProduct()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/stripe/model/Sku;->product:Lcom/stripe/model/ExpandableField;
...
.method public setDeleted(Ljava/lang/Boolean;)V
    ...
    iput-object p1, p0, Lcom/stripe/model/Sku;->deleted:Ljava/lang/Boolean;
...
.method public setInventory(Lcom/stripe/model/Sku$Inventory;)V
    .locals 0

    iput-object p1, p0, Lcom/stripe/model/Sku;->inventory:Lcom/stripe/model/Sku$Inventory;
...
.method public setObject(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/stripe/model/Sku;->object:Ljava/lang/String;
...
.method public setPrice(Ljava/lang/Long;)V
    ...
    iput-object p1, p0, Lcom/stripe/model/Sku;->price:Ljava/lang/Long;
...
.method public setProduct(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/stripe/model/Sku;->product:Lcom/stripe/model/ExpandableField;
...
.method public setProductObject(Lcom/stripe/model/Product;)V
    ...
    iput-object v0, p0, Lcom/stripe/model/Sku;->product:Lcom/stripe/model/ExpandableField;
...
.method public update(Lcom/stripe/param/SkuUpdateParams;)Lcom/stripe/model/Sku;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/stripe/model/Sku;->update(Lcom/stripe/param/SkuUpdateParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Sku;
...
.method public update(Lcom/stripe/param/SkuUpdateParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Sku;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
