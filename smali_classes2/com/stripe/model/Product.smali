...
.method public static create(Lcom/stripe/param/ProductCreateParams;)Lcom/stripe/model/Product;
    .locals 1
    ...
    invoke-static {p0, v0}, Lcom/stripe/model/Product;->create(Lcom/stripe/param/ProductCreateParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Product;
...
.method public static create(Lcom/stripe/param/ProductCreateParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Product;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    check-cast p0, Lcom/stripe/model/Product;
...
.method public static list(Lcom/stripe/param/ProductListParams;)Lcom/stripe/model/ProductCollection;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    invoke-static {p0, v0}, Lcom/stripe/model/Product;->list(Lcom/stripe/param/ProductListParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/ProductCollection;
...
.method public static list(Lcom/stripe/param/ProductListParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/ProductCollection;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    check-cast p0, Lcom/stripe/model/ProductCollection;
...
.method public static retrieve(Ljava/lang/String;)Lcom/stripe/model/Product;
    ...
    invoke-static {p0, v1, v0}, Lcom/stripe/model/Product;->retrieve(Ljava/lang/String;Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Product;
...
.method public static retrieve(Ljava/lang/String;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Product;
    ...
    invoke-static {p0, v0, p1}, Lcom/stripe/model/Product;->retrieve(Ljava/lang/String;Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Product;
...
.method public static retrieve(Ljava/lang/String;Lcom/stripe/param/ProductRetrieveParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Product;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
...
.method public static retrieve(Ljava/lang/String;Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Product;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected canEqual(Ljava/lang/Object;)Z
    ...
    instance-of p1, p1, Lcom/stripe/model/Product;

    return p1
.end method

.method public delete()Lcom/stripe/model/Product;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    invoke-virtual {p0, v1, v0}, Lcom/stripe/model/Product;->delete(Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Product;
...
.method public delete(Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Product;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    invoke-virtual {p0, v0, p1}, Lcom/stripe/model/Product;->delete(Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Product;
...
.method public delete(Ljava/util/Map;)Lcom/stripe/model/Product;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, v0}, Lcom/stripe/model/Product;->delete(Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Product;
...
.method public delete(Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Product;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getId()Ljava/lang/String;
    ...
    check-cast p1, Lcom/stripe/model/Product;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v1, p1, Lcom/stripe/model/Product;
    ...
    invoke-virtual {p1, p0}, Lcom/stripe/model/Product;->canEqual(Ljava/lang/Object;)Z
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getActive()Ljava/lang/Boolean;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getActive()Ljava/lang/Boolean;
    ...
    :cond_4
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getAttributes()Ljava/util/List;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getAttributes()Ljava/util/List;
    ...
    :cond_6
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getCaption()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getCaption()Ljava/lang/String;
    ...
    :cond_8
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getCreated()Ljava/lang/Long;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getCreated()Ljava/lang/Long;
    ...
    :cond_a
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getDeactivateOn()Ljava/util/List;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getDeactivateOn()Ljava/util/List;
    ...
    :cond_c
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getDeleted()Ljava/lang/Boolean;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getDeleted()Ljava/lang/Boolean;
    ...
    :cond_e
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getDescription()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getDescription()Ljava/lang/String;
    ...
    :cond_12
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getImages()Ljava/util/List;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getImages()Ljava/util/List;
    ...
    :cond_14
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getLivemode()Ljava/lang/Boolean;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getLivemode()Ljava/lang/Boolean;
    ...
    :cond_16
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getMetadata()Ljava/util/Map;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getMetadata()Ljava/util/Map;
    ...
    :cond_18
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getName()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getName()Ljava/lang/String;
    ...
    :cond_1a
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getObject()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getObject()Ljava/lang/String;
    ...
    :cond_1c
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getPackageDimensions()Lcom/stripe/model/PackageDimensions;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getPackageDimensions()Lcom/stripe/model/PackageDimensions;
    ...
    :cond_1e
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getShippable()Ljava/lang/Boolean;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getShippable()Ljava/lang/Boolean;
    ...
    :cond_20
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getStatementDescriptor()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getStatementDescriptor()Ljava/lang/String;
    ...
    :cond_22
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getType()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getType()Ljava/lang/String;
    ...
    :cond_24
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getUnitLabel()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getUnitLabel()Ljava/lang/String;
    ...
    :cond_26
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getUpdated()Ljava/lang/Long;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getUpdated()Ljava/lang/Long;
    ...
    :cond_28
    invoke-virtual {p0}, Lcom/stripe/model/Product;->getUrl()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Product;->getUrl()Ljava/lang/String;
...
.method public getDeactivateOn()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/stripe/model/Product;->deactivateOn:Ljava/util/List;
...
.method public getDeleted()Ljava/lang/Boolean;
    ...
    iget-object v0, p0, Lcom/stripe/model/Product;->deleted:Ljava/lang/Boolean;
...
.method public getObject()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/stripe/model/Product;->object:Ljava/lang/String;
...
.method public getStatementDescriptor()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/stripe/model/Product;->statementDescriptor:Ljava/lang/String;
...
.method public getType()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/stripe/model/Product;->type:Ljava/lang/String;
...
.method public getUnitLabel()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/stripe/model/Product;->unitLabel:Ljava/lang/String;
...
.method public setDeactivateOn(Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/stripe/model/Product;->deactivateOn:Ljava/util/List;
...
.method public setDeleted(Ljava/lang/Boolean;)V
    ...
    iput-object p1, p0, Lcom/stripe/model/Product;->deleted:Ljava/lang/Boolean;
...
.method public setObject(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/stripe/model/Product;->object:Ljava/lang/String;
...
.method public setStatementDescriptor(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/stripe/model/Product;->statementDescriptor:Ljava/lang/String;
...
.method public setType(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/stripe/model/Product;->type:Ljava/lang/String;

    return-void
.end method

.method public setUnitLabel(Ljava/lang/String;)V
    .locals 0

    iput-object p1, p0, Lcom/stripe/model/Product;->unitLabel:Ljava/lang/String;
...
.method public update(Lcom/stripe/param/ProductUpdateParams;)Lcom/stripe/model/Product;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/stripe/model/Product;->update(Lcom/stripe/param/ProductUpdateParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Product;
...
.method public update(Lcom/stripe/param/ProductUpdateParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Product;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
