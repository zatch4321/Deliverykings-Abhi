...
.field timesRedeemed:Ljava/lang/Long;
    .annotation runtime Lcom/google/gson/annotations/SerializedName;
...
.method public static create(Lcom/stripe/param/CouponCreateParams;)Lcom/stripe/model/Coupon;
    .locals 1
    ...
    invoke-static {p0, v0}, Lcom/stripe/model/Coupon;->create(Lcom/stripe/param/CouponCreateParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Coupon;
...
.method public static create(Lcom/stripe/param/CouponCreateParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Coupon;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    check-cast p0, Lcom/stripe/model/Coupon;
...
.method public static list(Lcom/stripe/param/CouponListParams;)Lcom/stripe/model/CouponCollection;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    invoke-static {p0, v0}, Lcom/stripe/model/Coupon;->list(Lcom/stripe/param/CouponListParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/CouponCollection;
...
.method public static list(Lcom/stripe/param/CouponListParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/CouponCollection;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    check-cast p0, Lcom/stripe/model/CouponCollection;
...
.method public static retrieve(Ljava/lang/String;)Lcom/stripe/model/Coupon;
    ...
    invoke-static {p0, v1, v0}, Lcom/stripe/model/Coupon;->retrieve(Ljava/lang/String;Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Coupon;
...
.method public static retrieve(Ljava/lang/String;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Coupon;
    ...
    invoke-static {p0, v0, p1}, Lcom/stripe/model/Coupon;->retrieve(Ljava/lang/String;Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Coupon;
...
.method public static retrieve(Ljava/lang/String;Lcom/stripe/param/CouponRetrieveParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Coupon;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
...
.method public static retrieve(Ljava/lang/String;Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Coupon;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected canEqual(Ljava/lang/Object;)Z
    ...
    instance-of p1, p1, Lcom/stripe/model/Coupon;

    return p1
.end method

.method public delete()Lcom/stripe/model/Coupon;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    invoke-virtual {p0, v1, v0}, Lcom/stripe/model/Coupon;->delete(Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Coupon;
...
.method public delete(Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Coupon;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    invoke-virtual {p0, v0, p1}, Lcom/stripe/model/Coupon;->delete(Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Coupon;
...
.method public delete(Ljava/util/Map;)Lcom/stripe/model/Coupon;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, v0}, Lcom/stripe/model/Coupon;->delete(Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Coupon;
...
.method public delete(Ljava/util/Map;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Coupon;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0}, Lcom/stripe/model/Coupon;->getId()Ljava/lang/String;
    ...
    check-cast p1, Lcom/stripe/model/Coupon;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v1, p1, Lcom/stripe/model/Coupon;
    ...
    invoke-virtual {p1, p0}, Lcom/stripe/model/Coupon;->canEqual(Ljava/lang/Object;)Z
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/stripe/model/Coupon;->getAmountOff()Ljava/lang/Long;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Coupon;->getAmountOff()Ljava/lang/Long;
    ...
    :cond_4
    invoke-virtual {p0}, Lcom/stripe/model/Coupon;->getCreated()Ljava/lang/Long;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Coupon;->getCreated()Ljava/lang/Long;
    ...
    :cond_6
    invoke-virtual {p0}, Lcom/stripe/model/Coupon;->getCurrency()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Coupon;->getCurrency()Ljava/lang/String;
    ...
    :cond_8
    invoke-virtual {p0}, Lcom/stripe/model/Coupon;->getDeleted()Ljava/lang/Boolean;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Coupon;->getDeleted()Ljava/lang/Boolean;
    ...
    :cond_a
    invoke-virtual {p0}, Lcom/stripe/model/Coupon;->getDuration()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Coupon;->getDuration()Ljava/lang/String;
    ...
    :cond_c
    invoke-virtual {p0}, Lcom/stripe/model/Coupon;->getDurationInMonths()Ljava/lang/Long;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Coupon;->getDurationInMonths()Ljava/lang/Long;
    ...
    :cond_10
    invoke-virtual {p0}, Lcom/stripe/model/Coupon;->getLivemode()Ljava/lang/Boolean;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Coupon;->getLivemode()Ljava/lang/Boolean;
    ...
    :cond_12
    invoke-virtual {p0}, Lcom/stripe/model/Coupon;->getMaxRedemptions()Ljava/lang/Long;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Coupon;->getMaxRedemptions()Ljava/lang/Long;
    ...
    :cond_14
    invoke-virtual {p0}, Lcom/stripe/model/Coupon;->getMetadata()Ljava/util/Map;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Coupon;->getMetadata()Ljava/util/Map;
    ...
    :cond_16
    invoke-virtual {p0}, Lcom/stripe/model/Coupon;->getName()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Coupon;->getName()Ljava/lang/String;
    ...
    :cond_18
    invoke-virtual {p0}, Lcom/stripe/model/Coupon;->getObject()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Coupon;->getObject()Ljava/lang/String;
    ...
    :cond_1a
    invoke-virtual {p0}, Lcom/stripe/model/Coupon;->getPercentOff()Ljava/math/BigDecimal;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Coupon;->getPercentOff()Ljava/math/BigDecimal;
    ...
    :cond_1c
    invoke-virtual {p0}, Lcom/stripe/model/Coupon;->getRedeemBy()Ljava/lang/Long;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Coupon;->getRedeemBy()Ljava/lang/Long;
    ...
    :cond_1e
    invoke-virtual {p0}, Lcom/stripe/model/Coupon;->getTimesRedeemed()Ljava/lang/Long;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Coupon;->getTimesRedeemed()Ljava/lang/Long;
    ...
    :cond_20
    invoke-virtual {p0}, Lcom/stripe/model/Coupon;->getValid()Ljava/lang/Boolean;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Coupon;->getValid()Ljava/lang/Boolean;
...
.method public getAmountOff()Ljava/lang/Long;
    ...
    iget-object v0, p0, Lcom/stripe/model/Coupon;->amountOff:Ljava/lang/Long;
...
.method public getDeleted()Ljava/lang/Boolean;
    ...
    iget-object v0, p0, Lcom/stripe/model/Coupon;->deleted:Ljava/lang/Boolean;
...
.method public getDurationInMonths()Ljava/lang/Long;
    ...
    iget-object v0, p0, Lcom/stripe/model/Coupon;->durationInMonths:Ljava/lang/Long;
...
.method public getName()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/stripe/model/Coupon;->name:Ljava/lang/String;
...
.method public getObject()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/stripe/model/Coupon;->object:Ljava/lang/String;
...
.method public getPercentOff()Ljava/math/BigDecimal;
    ...
    iget-object v0, p0, Lcom/stripe/model/Coupon;->percentOff:Ljava/math/BigDecimal;
...
.method public getTimesRedeemed()Ljava/lang/Long;
    .locals 1

    iget-object v0, p0, Lcom/stripe/model/Coupon;->timesRedeemed:Ljava/lang/Long;
...
.method public setAmountOff(Ljava/lang/Long;)V
    .locals 0

    iput-object p1, p0, Lcom/stripe/model/Coupon;->amountOff:Ljava/lang/Long;
...
.method public setDeleted(Ljava/lang/Boolean;)V
    ...
    iput-object p1, p0, Lcom/stripe/model/Coupon;->deleted:Ljava/lang/Boolean;
...
.method public setDurationInMonths(Ljava/lang/Long;)V
    .locals 0

    iput-object p1, p0, Lcom/stripe/model/Coupon;->durationInMonths:Ljava/lang/Long;
...
.method public setName(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/stripe/model/Coupon;->name:Ljava/lang/String;
...
.method public setObject(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/stripe/model/Coupon;->object:Ljava/lang/String;

    return-void
.end method

.method public setPercentOff(Ljava/math/BigDecimal;)V
    .locals 0

    iput-object p1, p0, Lcom/stripe/model/Coupon;->percentOff:Ljava/math/BigDecimal;
...
.method public setTimesRedeemed(Ljava/lang/Long;)V
    .locals 0

    iput-object p1, p0, Lcom/stripe/model/Coupon;->timesRedeemed:Ljava/lang/Long;
...
.method public update(Lcom/stripe/param/CouponUpdateParams;)Lcom/stripe/model/Coupon;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/stripe/model/Coupon;->update(Lcom/stripe/param/CouponUpdateParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Coupon;
...
.method public update(Lcom/stripe/param/CouponUpdateParams;Lcom/stripe/net/RequestOptions;)Lcom/stripe/model/Coupon;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/stripe/exception/StripeException;
