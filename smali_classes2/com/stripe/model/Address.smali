.class public Lcom/stripe/model/Address;
...
.method protected canEqual(Ljava/lang/Object;)Z
    ...
    instance-of p1, p1, Lcom/stripe/model/Address;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v1, p1, Lcom/stripe/model/Address;
    ...
    invoke-virtual {p1, p0}, Lcom/stripe/model/Address;->canEqual(Ljava/lang/Object;)Z
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/stripe/model/Address;->getCity()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Address;->getCity()Ljava/lang/String;
    ...
    :cond_4
    invoke-virtual {p0}, Lcom/stripe/model/Address;->getCountry()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Address;->getCountry()Ljava/lang/String;
    ...
    :cond_6
    invoke-virtual {p0}, Lcom/stripe/model/Address;->getLine1()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Address;->getLine1()Ljava/lang/String;
    ...
    :cond_8
    invoke-virtual {p0}, Lcom/stripe/model/Address;->getLine2()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Address;->getLine2()Ljava/lang/String;
    ...
    :cond_a
    invoke-virtual {p0}, Lcom/stripe/model/Address;->getPostalCode()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Address;->getPostalCode()Ljava/lang/String;
    ...
    :cond_c
    invoke-virtual {p0}, Lcom/stripe/model/Address;->getState()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lcom/stripe/model/Address;->getState()Ljava/lang/String;
